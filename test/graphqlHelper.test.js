...
const {getSchemaByQueryName, loopFindSchemaTypeChild} = require("../utils/graphql-helper");
...
const suite = new Benchmark.Suite('graphqlTools', {
    'maxTime': 3, "minSamples": 1
});

// add tests
suite.add('buildSchemaTree#CDD', test.bind(null, 'cddNoteList'))
